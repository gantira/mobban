...
@section('info')
    <div class="d-flex align-items-center flex-wrap mr-1">
        ...
        <div class="d-flex flex-column">
            <!--begin::Title-->
            <h2 class="text-white font-weight-bold my-2 mr-5">Role</h2>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <div class="d-flex align-items-center font-weight-bold my-2">
                ...
                <!--begin::Item-->
                <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
                <a href="#" class="text-white text-hover-white opacity-75 hover-opacity-100" disabled>Role</a>
                <!--end::Item-->
            </div>
            <!--end::Breadcrumb-->
        </div>
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        @forelse ($roles as $item)
                            <tr>
                                <td>{{ $item->name }}</td>
                                <td>{{ $item->getPermissionNames()->join(', ') }}</td>
