            ...
            <div class="card card-custom card-stretch gutter-b">
                ...
                <div class="card-body d-flex flex-column">
                    <div class="flex-grow-1 pb-5">
                        ...
                        <!--end::Info-->
                        <a href="#" class="text-dark font-weight-bolder text-hover-primary font-size-h4">Craft - ReactJS
                            Admin
                            <br />Theme</a>
                        <!--begin::Desc-->
            ...
            <div class="card card-custom card-stretch gutter-b">
                ...
                <div class="card-body d-flex flex-column">
                    <div class="flex-grow-1 pb-5">
                        ...
                        <!--end::Info-->
                        <a href="#" class="text-dark font-weight-bolder text-hover-primary font-size-h4">KT.com - High
                            Quality
                            <br />Templates</a>
                        <!--begin::Desc-->
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="d-flex align-items-center mb-9 bg-light-warning rounded p-5">
                        ...
                        <div class="d-flex flex-column flex-grow-1 mr-2">
                            <a href="#" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Group
                                lunch celebration</a>
                            <span class="text-muted font-weight-bold">Due in 2 Days</span>
                        </div>
                        <!--end::Title-->
                    ...
                    <div class="d-flex align-items-center bg-light-success rounded p-5 mb-9">
                        ...
                        <!--begin::Title-->
                        <div class="d-flex flex-column flex-grow-1 mr-2">
                            <a href="#" class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Home
                    ...
                    <div class="d-flex align-items-center bg-light-info rounded p-5">
                        ...
                        <div class="d-flex flex-column flex-grow-1 mr-2">
                            <a href="#"
                                class="font-weight-bold text-dark-75 text-hover-primary font-size-lg mb-1">Product goals
                                strategy meet-up</a>
                            <span class="text-muted font-weight-bold">Due in 2 Days</span>
                        </div>
                        <!--end::Title-->
