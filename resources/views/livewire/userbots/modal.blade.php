                    ...
                    <div class="">
                        ...
                        <div class="form-group">
                            ...
                            <input wire:model.defer="bot" type="text"
                                class="form-control @error('bot') is_invalid @enderror" placeholder="" />
                            @error('bot')
                        ...
                        <div class="form-group">
                            ...
                            <input wire:model.defer="user_name_telegram" type="text" class="form-control @error('user_name_telegram') is_invalid @enderror"
                                placeholder="" />
