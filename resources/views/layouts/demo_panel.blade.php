        ...
        <div class="offcanvas-wrapper mb-5 scroll-pull">
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                ...
                <div class="overlay-layer">
                    <a href="{{ asset('../../demo1/dist') }}" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo offcanvas-demo-active">
                ...
                <div class="overlay-layer">
                    <a href="{{ asset('../../demo2/dist') }}" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                ...
                <div class="overlay-layer">
                    <a href="{{ asset('../../demo3/dist') }}" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                ...
                <div class="overlay-layer">
                    <a href="{{ asset('../../demo4/dist') }}" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                ...
                <div class="overlay-layer">
                    <a href="{{ asset('../../demo5/dist') }}" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                ...
                <div class="overlay-layer">
                    <a href="{{ asset('../../demo6/dist') }}" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                ...
                <div class="overlay-layer">
                    <a href="{{ asset('../../demo7/dist') }}" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                ...
                <div class="overlay-layer">
                    <a href="{{ asset('../../demo8/dist') }}" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                ...
                <div class="overlay-layer">
                    <a href="{{ asset('../../demo9/dist') }}" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                ...
                <div class="overlay-layer">
                    <a href="{{ asset('../../demo10/dist') }}" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                ...
                <div class="overlay-layer">
                    <a href="{{ asset('../../demo11/dist') }}" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                ...
                <div class="overlay-layer">
                    <a href="{{ asset('../../demo12/dist') }}" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
            ...
            <div class="overlay rounded-lg mb-8 offcanvas-demo">
                ...
                <div class="overlay-layer">
                    <a href="{{ asset('../../demo13/dist') }}" class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow" target="_blank">Default</a>
