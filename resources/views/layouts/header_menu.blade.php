<div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
    ...
    <div id="kt_header_menu" class="header-menu header-menu-left header-menu-mobile header-menu-layout-default">
        <!--begin::Header Nav-->
        <ul class="menu-nav">
            <li class="menu-item {{ Request::segment(1) == '' ? 'menu-item-active' : null }}">
            ...
            <li class="menu-item menu-item-submenu menu-item-rel {{ in_array(Request::segment(1), ['botsfs','botteknisis']) ? 'menu-item-active' : null }}" data-menu-toggle="click" aria-haspopup="true">
                ...
                <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                    <ul class="menu-subnav">
                        <li class="menu-item {{ Request::segment(1) == 'botsfs' ? 'menu-item-active' : null }}" aria-haspopup="true">
                            <a href="{{ route('botsfs.index') }}" class="menu-link">
                        ...
                        <li class="menu-item {{ Request::segment(1) == 'botteknisis' ? 'menu-item-active' : null }}" aria-haspopup="true">
                            <a href="{{ route('botteknisis.index') }}" class="menu-link">
                                <span class="svg-icon menu-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <li class="menu-item menu-item-submenu menu-item-rel {{ in_array(Request::segment(1), ['userbots','botteknisis']) ? 'menu-item-active' : null }}" data-menu-toggle="click" aria-haspopup="true">
                ...
                <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                    <ul class="menu-subnav">
                        <li class="menu-item {{ Request::segment(1) == 'userbots' ? 'menu-item-active' : null }}" aria-haspopup="true">
                        ...
                        <li class="menu-item {{ Request::segment(1) == 'users' ? 'menu-item-active' : null }}" aria-haspopup="true">
                            <a href="{{ route('users.index') }}" class="menu-link">
                                ...
                                <span class="menu-text">User Web</span>
                                {{-- <span class="menu-label">
                                    <span class="label label-danger label-inline">new</span>
                                </span> --}}
                            </a>
            ...
            {{-- <li class="menu-item menu-item-submenu menu-item-rel"
                ...
                <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                    <ul class="menu-subnav">
                        ...
                        <li class="menu-item" aria-haspopup="true">
                            <a target="_blank" href="https://preview.keenthemes.com/metronic/demo2/builder.html"
                                class="menu-link">
                                <span class="svg-icon menu-icon">
